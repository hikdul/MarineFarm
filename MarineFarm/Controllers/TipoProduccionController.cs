...
namespace MarineFarm.Controllers
{
    ...
    public class TipoProduccionController : Controller
    {
        ...
        public TipoProduccionController(ApplicationDbContext context, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Guardar(GTipoDTO_in ins)
        {
            try
            {
                var ent = mapper.Map<TipoProduccion>(ins);
                context.Add(ent);
        ...
        public async Task<IActionResult> Save(GTipoDTO_edit ins)
        {
            try
            {
                var ent = await context.TiposProduccion
